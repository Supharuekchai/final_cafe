...
namespace final_cafe
{
    class DataAccess
    {
        ...
        public ArrayList RetreiveProductsFromCategory(int CategoryID)
        {
            ...
            using (MySqlConnection connection = new MySqlConnection(ConnectionString))
            {
                MySqlCommand command = new MySqlCommand("SELECT ProductID, ProductName, ProductPrice, ProductDetail, ProductImage FROM products where ProductCategoryID = '" + CategoryID + "';", connection);
                connection.Open();
        ...
        public Details RetreiveProductDetails(int ProductID)
        {
            ...
            using (MySqlConnection connection = new MySqlConnection(ConnectionString))
            {
                MySqlCommand command = new MySqlCommand("SELECT ProductName, ProductPrice, ProductCategoryID, ProductDetail, ProductImage FROM products where ProductID = '" + ProductID + "';", connection);
                connection.Open();
