...
namespace final_cafe
{
    public partial class Staff_Form : Form
    {
        public Staff_Form(int StaffID)
        {
            ...
            Username = _DataAccess.ReturnUserName(StaffID);
        }
        ...
        {
            MessageBox.Show("ไม่สามารถทำรายการต่อได้");
        }
        ...
        private void ProductsGridView_CellContentClick_1(object sender, DataGridViewCellEventArgs e)
        {
            if (e.RowIndex >= 0)
            {
                ...
                {
                    if (MessageBox.Show("คุณต้องการลบรายการนี้ออกหรือไม่?", "ลบรายการที่สั่ง", MessageBoxButtons.YesNo) == DialogResult.Yes)
                    {
