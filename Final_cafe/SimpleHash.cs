...
namespace final_cafe
{
    class SimpleHash
    {
        ...
        private static string _ComputeHash(string plainText, byte[] saltBytes)
        {
        ...
        private static bool _VerifyHash(string plainText,string hashValue)
        {
            ...
            string expectedHashString = _ComputeHash(plainText, saltBytes);
